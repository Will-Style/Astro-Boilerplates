        ...
        <header class="lower__header">
            <div class="container">
                <h2 class="lower__header__title">
                    <div class="lower__header__title-en"><span>Privacy policy</span></div>
                </h2>
            </div>
        </header>
        <div data-not-top class="container">
            <div class="">
                <h3 class="pp__title">はじめに</h3>
                <div class="pp__content">
                    <p>
                        テスト株式会社（以下、「当社」）は、各種サービスのご提供にあたり、お客様の個人情報をお預かりしております。<br>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の取得について</h3>
                <div class="pp__content">
                    <p>
                        当社は、偽りその他不正の手段によらず適正に個人情報を取得致します。なお、次のような場合に必要な範囲で個人情報を収集する場合があります。<br>
                    </p>
                    <ol class="mt-3 ml65 ordering-list">
                        <li>ご相談・お問い合わせ</li>
                        <li>採用エントリー</li>
                    </ol>
                </div>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の利用について</h3>
                ...
                <div class="pp__content">
                    ...
                    <ol class="mt-3 ml65">
                        <li>ご相談・お問い合わせに対するご回答のご連絡のため</li>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の安全管理について</h3>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の委託について</h3>
                <div class="pp__content">
                    <p>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の第三者提供について</h3>
                <div class="pp__content">
                    <p>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の開示・訂正等について</h3>
                <div class="pp__content">
                    <p>
                    ...
                    <h4 class="pp__title mt-25">連絡先</h4>
                    <table class="table table-bordered pp__table mt-15">
                        <tbody>
                            <tr>
                                <th>名称</th>
                                <td>テスト株式会社</td>
                            ...
                            <tr>
                                ...
                                <td>〒650-0024 神戸市中央区海岸通5 商船三井ビルディング4F</td>
                            </tr>
                            <tr>
                                <th>TEL</th>
                                <td>078-977-8760</td>
            ...
            <div class="mt-30">
                <h3 class="pp__title">その他の注意事項</h3>
                <div class="pp__content">
                    <p>
            ...
            <div class="mt-30">
                <h3 class="pp__title">個人情報の管理方法の継続的改善について</h3>
                <div class="pp__content">
                    <p>
            ...
            <div class="text-center py-80">
                <button data-window-close class="button form__return-top">
                    ウィンドウを閉じる
                </button>
            </div>
        </div>
