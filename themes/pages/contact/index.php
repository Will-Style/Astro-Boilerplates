                                    ...
                                    <form class="form" method="post" action="?sendmail=contact" data-form>
                                        ...
                                        <div v-show="!isConfirm">
                                            ...
                                            <div class="form__row mt-20">
                                                ...
                                                <div class="form__content form__vertical">
                                                    <label class="form__check-label"><input name="contact_type" type="checkbox" value="ご相談" :checked="type==1" @change="notChecked">ご相談</label>
                                                    <label class="form__check-label"><input name="contact_type" type="checkbox" value="資料請求" :checked="type==2" @change="notChecked">資料請求</label>
                                                </div>
                                            ...
                                            <div class="form__row">
                                                ...
                                                <div class="form__content">
                                                    <input type="text" name="kana" placeholder="フリガナ" @blur="notEmptyKana">
                                                    <div class="form__invalid" v-if="errors.kana == 'empty'">フリガナを入力してください。</div>
                                                    <div class="form__invalid" v-if="errors.kana == 'not_kana'">全角カタカナで入力してください。</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form__confirm__hidden gap-y-10 form__row">
                                                <div class="form__content">
                                                    ...
                                                    <div class="form__pp__agree text-center pt-40">
                                                        <label class="form__check-label"><input name="privacy_agree" type="checkbox" value="個人情報の取り扱いに同意する" :checked="type==1" @change="notChecked">個人情報の取り扱いに同意する</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div v-show="isConfirm">
                                            ...
                                            <div class="form__row">
                                                <label class="form__label form__require">お問い合わせ内容</label>
                                                <div class="form__content">
                                                    <div v-text="data.message" class="white-space-pre-wrap"></div>
                                                </div>
                                            </div>
