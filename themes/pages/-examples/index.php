                                ...
                                <div class="form__wrapper py-60">
                                    ...
                                    <form class="form" method="post" action="?sendmail=example" data-form>
                                        ...
                                        <div v-show="!isConfirm">
                                            ...
                                            <div class="form__row">
                                                <label class="form__label form__require">お問い合わせの種類</label>
                                                <div class="form__content">
                                                    <select name="contact_type" @change="notEmpty" class="form__items__name">
                                                        <option value="">選択してください</option>
                                                        <option value="ご相談">ご相談</option>
                                                        <option value="資料請求">資料請求</option>
                                                        <option value="オンライン相談会">オンライン相談会</option>
                                                    </select>
                                                    <div class="form__invalid mb-10" v-if="errors.contact_type">お問い合わせの種類を選択してください。</div>
                                            ...
                                            <div class="form__row">
                                                ...
                                                <div v-if="files.file02.url == ''">
                                                    <div class="form__content">
                                                        <input type="file" maxsize="1024*1024*10" accept="
                                                            image/png,
                                                            image/jpeg,
                                                            image/gif,
                                                            application/pdf,
                                                            application/zip
                                                        " name="file02" @change="onUpload($event,'file02')">
                                                    </div>
                                                    <div class="form__notice mt-5">
                                                        ※ファイルサイズの上限は10MBまでです。<br>
                                                        ※上限を超える場合は<a href="https://gigafile.nu/" target="_blank">ファイル便</a>等をご利用ください。<br>
